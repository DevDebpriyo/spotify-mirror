...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-spotify-dark-elevated to-spotify-black flex flex-col">
      {/* Header */}
      <header className="p-8 flex justify-center border-b border-border">
      ...
      <main className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
          <h1 className="text-4xl font-bold text-center">Log in to Spotify</h1>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-spotify-black text-muted-foreground">or</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 rounded border-muted-foreground bg-transparent checked:bg-primary"
              />
